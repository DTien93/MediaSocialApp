      ...
      <div className='topbar__container'>
          <div className='topbar__left'>
              <Link to='/' style={{textDecoration: 'none'}}>
                  ...
                  <img src='https://static.vecteezy.com/system/resources/thumbnails/004/263/114/small/meta-logo-meta-by-facebook-icon-editorial-logo-for-social-media-free-vector.jpg' alt='' className='topbar__logo'/>
              </Link>                                                                                           
          </div>
